...
È il modo più semplice per utilizzare il caricamento lazy installando il [Microsoft.EntityFramworkCore.Proxies](https://www.nuget.org/packages/Microsoft.EntityFrameworkCore.Proxies/) pacchetto e abilitarlo con una chiamata a `UseLazyLoadingProxies`. Ad esempio:
```Csharp
