...
| [Oracle.EntityFrameworkCore](https://www.nuget.org/packages/Oracle.EntityFrameworkCore/)                             | Oracle                     | [Oracle](https://www.oracle.com/technetwork/topics/dotnet/)                   | Prerelease           | [sito Web](https://www.oracle.com/technetwork/topics/dotnet/)                                                                                                                                       |
...
### <a name="oracle-first-party-provider"></a>Provider proprietario Oracle
Il team Oracle .NET ha pubblicato la versione beta del [provider Oracle per EF Core](https://www.nuget.org/packages/Oracle.EntityFrameworkCore/).
