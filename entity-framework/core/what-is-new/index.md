...
Preview 2 include un importante contributo di [Paul Middleton](https://github.com/pmiddleton) che consente il mapping delle funzioni scalari del database agli stub di metodo in modo da poterli usare nelle query LINQ e convertire in SQL.
...
I metodi come questo vengono registrati automaticamente. Dopo che un metodo è stato registrato sarà possibile usarlo ovunque nelle query:
...
- È necessario creare la funzione mappata nel database. Durante le migrazioni EF Core non viene infatti creata.
