...
L'elemento **mapping** è l'elemento radice per una specifica di mapping. Lo spazio dei nomi XML per il mapping di specifiche https://schemas.microsoft.com/ado/2009/11/mapping/cs .
